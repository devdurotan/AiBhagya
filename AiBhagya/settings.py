...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '18.224.34.42','aibhgya.com','www.aibhgya.com','18.227.79.69'] + config('ALLOWED_HOSTS', default='', cast=Csv())
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=config('JWT_ACCESS_MINUTES', default=6000, cast=int)),
